		...
		<main>
			...
			<div class="table-data">
				<div class="order">
					<div class="head">
						<h3>Recent Orders</h3>
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"style=" width:70px;height: 35px;"><a href="http:add-anonce.php" style="color:#fff;">Add</a></button>
					...
					<table>
						...
						<tbody>
                        <?php 
                     $users=$bdd->query('SELECT * FROM anonce');
                 while($use=$users->fetch()){
                    ?>
             <tr>
             <td><br><?php echo $use['titre'] ?></td>
                <td><?php echo $use['info'] ?></td>
                <td><?php echo $use['link'] ?></td>
                
        <td>
        <a href="modify-anonce.php?titre=<?=$use['titre']; ?>"><button class="btn btn-success">Update</button></a>

            <a href="sup-anonce.php?titre=<?=$use['titre']; ?>"><button class="btn btn-danger">Delete</button></a>
